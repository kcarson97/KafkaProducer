...
public class DataGenerator {
    ...
    public String quoteFaker(){
        ...
        quoteData.put("src",faker.company().name().toUpperCase());
     ...
     */
    public String tradeFaker(){

        Map<String,Object> tradeData = new HashMap<>();

        tradeData.put("time",new SimpleDateFormat("yyyy.MM.dd_HHmmss").format(Calendar.getInstance().getTime()));
        tradeData.put("sym",faker.stock().nyseSymbol());
